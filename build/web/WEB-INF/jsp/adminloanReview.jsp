<%-- 
    Document   : adminloanReview
    Created on : May 9, 2020, 3:28:24 PM
    Author     : franc
--%>
                ...
                <tr> 
                    ...
                    <c:choose>
                        <c:when test= "${loan.loanstatus eq 0}">
                            <td><a href="reviewadminLoan/${loan.id}/${loan.lastname}/${loan.firstname}/${loan.dept}/${loan.jobtype}/${loan.loanamount}/${loan.loanrequestdate}/${loan.loanpaydate}/${loan.loanreason}/${loan.username}/" class="btn btn-primary link">Review</a></td>
                        </c:when>
