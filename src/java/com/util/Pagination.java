    ...
    public String getControls() {
        ...
        if (last != 1) {
            ...
            if (this.page_num != last) {
                ...
                int lastView = (int) Math.round(last);
                nextBtn = "<li class=\"page-item\"><a class=\"page-link link\" href=" + (this.link + next) + ">NEXT</a></li>";
                lastBtn = "<li class=\"page-item\"><a class=\"page-link link\" href=" + (this.link + lastView) + ">LAST</a></li>";

            } else {
                nextBtn = "<li class=\"page-item disabled\"><a class=\"page-link link\" href=\"#\" onclick=\"return false;\" tabindex=+1>NEXT</a></li>";
                lastBtn = "<li class=\"page-item disabled\"><a class=\"page-link link\" href=\"#\" onclick=\"return false;\">LAST</a></li>";
            }

            if (page_num != 1) {
                int firstView = 1;
                firstBtn = "<li class=\"page-item\"><a class=\"page-link link\" href=" + (this.link + firstView) + ">FIRST</a></li>";

            } else {
                firstBtn = "<li class=\"page-item disabled\"><a class=\"page-link link\" href=\"#\" onclick=\"return false;\" tabindex=1>FIRST</a></li>";
            }
        }

        return open + firstBtn + previousBtn + centerLeft + center + centerRight + nextBtn + lastBtn + close;
    }
