<%-- 
    Document   : staffList
    Created on : Mar 5, 2020, 6:15:33 PM
    Author     : franc
--%>
...
<div class="card">
    ...
    <div class="modal-body">
          <div class="row">
         <div class="col-md-4">
            <a href="addstaff" class="btn btn-primary link">Add</a>
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <div class="modal-footer">
        <button type="button" class="btn btn-primary" id="deleteStaff" data-dismiss="modal">Yes</button>
