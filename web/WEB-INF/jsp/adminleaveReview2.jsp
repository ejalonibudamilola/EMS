<%-- 
    Document   : adminleaveReview2
    Created on : May 9, 2020, 4:16:00 PM
    Author     : franc
--%>
<%-- 
...
<div class="card">
    ...
    <div class="modal-body">
        <div class="row">
         <div class="col-md-4">
             <a href="adminleavemanagement" class="btn btn-primary link">Back</a>
                ...
                <tr>
                    ...
                    <c:choose>
                        <c:when test= "${leave.leave_status eq 0}">
                            <td><a href="reviewLeave/${leave.lastname}/${leave.firstname}/${leave.dept}/${leave.jobtype}/${leave.lrd}/${leave.duration}/${leave.lsd}/${leave.led}/${leave.leave_reason}/${leave.username}/" class="btn btn-primary link">Review</a></td>
                        </c:when>
