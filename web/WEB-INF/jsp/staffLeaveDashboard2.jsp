<%-- 
    Document   : staffLeaveDashboard2
    Created on : Apr 11, 2020, 6:57:29 PM
    Author     : franc
--%>
...
<div class="card">
    ...
    <div class="modal-body">
          <div class="row">
         <div class="col-md-4">
            <a href="leaverequestmanagement" class="btn btn-primary link">Back</a>            
         </div>        
                ...
                <form action="searchLeaveByStaff" method="post">
                    ...
                    <div class="input-group mb-3">
                        ...
                        <select class="custom-select" id="search_by" name="search_by">
                            ...
                            <option value="leave_request_date">Loan Request Date</option>
